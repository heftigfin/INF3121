...
public class Ranking{
	...
	//records player name after game ends.
	...
	//shows top 5 results. checks if a result is present before continuing.
	public void show() {
		if(last==0){
	...
	//sorts player names by biggest score. Checks if there are more than one result before continuing.
	private void sort(){
		if(last<2) return;
